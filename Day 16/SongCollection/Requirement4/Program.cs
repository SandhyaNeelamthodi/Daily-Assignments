    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (n1 == 1)
            {
                ...
                {
                    Console.WriteLine("{0} {1,15} {2,15} {3,15} {4,15} {5,15}", item.Name, item.Artist, item.SongType, item.DateDownloaded.ToString("dd-MM-yyyy"), item.Rating.ToString("0.0"), item.NoOfDownloads);
