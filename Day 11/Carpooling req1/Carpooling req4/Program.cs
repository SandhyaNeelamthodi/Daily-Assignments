        ...
        static void Main(string[] args)
        {
...

            {
                ...
                case "hatchback":
                    ...
                    HatchBack hatchback = new HatchBack(powerWindows,automaticGear,id,name);
                ...
                case "sedan":
                    ...
                    Sedan sedan = new Sedan(absEnabled, bootSpace, id, name);
                ...
                case "utility":
                    ...
                    UtilityCar utilityCar = new UtilityCar( rearCoolingVents,id,name);
